...
package com.shatteredpixel.bathredpixeldungeon.desktop;
...
import com.shatteredpixel.bathredpixeldungeon.services.news.NewsImpl;
import com.shatteredpixel.bathredpixeldungeon.services.updates.UpdateImpl;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.shatteredpixel.bathredpixeldungeon.", "");
		...
		// (e.g. /.shatteredpixel/bathredpixeldungeon), but we have too much existing save
