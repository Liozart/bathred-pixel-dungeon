...
import com.shatteredpixel.bathredpixeldungeon.effects.particles.FlameParticle;
import com.shatteredpixel.bathredpixeldungeon.levels.painters.Painter;
import com.shatteredpixel.bathredpixeldungeon.levels.painters.PrisonPainter;
...
public class PrisonLevel extends RegularLevel {
	...
	protected Painter painter() {
		return new PrisonPainter()
				...
				.setGrass(feeling == Feeling.GRASS ? 0.80f : 0.30f, 3)
