...
import com.shatteredpixel.bathredpixeldungeon.items.armor.MailArmor;
import com.shatteredpixel.bathredpixeldungeon.items.armor.PlateArmor;
import com.shatteredpixel.bathredpixeldungeon.items.armor.RogueArmor;
import com.shatteredpixel.bathredpixeldungeon.items.armor.ScaleArmor;
import com.shatteredpixel.bathredpixeldungeon.items.armor.WarriorArmor;
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.AlchemistsToolkit;
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.Artifact;
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.ChaliceOfBlood;
...
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.EtherealChains;
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.HornOfPlenty;
...
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.TalismanOfForesight;
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.TimekeepersHourglass;
import com.shatteredpixel.bathredpixeldungeon.items.artifacts.UnstableSpellbook;
...
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfAccuracy;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfArcana;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfElements;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfEnergy;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfEvasion;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfForce;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfFuror;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfHaste;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfMight;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfSharpshooting;
import com.shatteredpixel.bathredpixeldungeon.items.rings.RingOfTenacity;
...
import com.shatteredpixel.bathredpixeldungeon.items.scrolls.ScrollOfTerror;
...
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfAugmentation;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfBlast;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfBlink;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfClairvoyance;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfDeepSleep;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfDisarming;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfEnchantment;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfFear;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfFlock;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfIntuition;
import com.shatteredpixel.bathredpixeldungeon.items.stones.StoneOfShock;
...
import com.shatteredpixel.bathredpixeldungeon.items.wands.WandOfCorrosion;
...
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Dirk;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.DualPistol;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Flail;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Gauntlet;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Glaive;
...
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Greataxe;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Greatshield;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Greatsword;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.HandAxe;
...
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Katana;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Longsword;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Mace;
...
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.RoundShield;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.RunicBlade;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Sai;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Scimitar;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Shortsword;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Sickle;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.SniperRifle;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Spear;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.SubMachinegun;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.Sword;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.melee.WarHammer;
...
import com.shatteredpixel.bathredpixeldungeon.items.weapon.missiles.ThrowingClub;
import com.shatteredpixel.bathredpixeldungeon.items.weapon.missiles.ThrowingHammer;
...
import com.shatteredpixel.bathredpixeldungeon.items.weapon.missiles.Tomahawk;
...
public class Generator {
	...
	public enum Category {
		...
		static {
			...
			WEP_T2.defaultProbs = new float[]{ 3, 3, 3, 3, 3, 3, 4, 4, 4 };
			...
			WEP_T3.defaultProbs = new float[]{ 3, 3, 3, 3, 3, 3, 4, 4, 4 };
			...
			WEP_T4.defaultProbs = new float[]{ 3, 3, 3, 3, 3, 3, 3, 4, 4, 4 };
