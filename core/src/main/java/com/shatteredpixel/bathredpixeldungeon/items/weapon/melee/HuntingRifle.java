...
import com.shatteredpixel.bathredpixeldungeon.items.bombs.Firebomb;
import com.shatteredpixel.bathredpixeldungeon.items.bombs.Flashbang;
...
public class HuntingRifle extends MeleeWeapon {
    ...
    public int STRReq(int lvl) {
        return STRReq(tier, lvl); //18 base strength req
    }
