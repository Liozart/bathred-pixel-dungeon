...
import com.shatteredpixel.bathredpixeldungeon.actors.mobs.RotHeart;
...
import com.shatteredpixel.bathredpixeldungeon.items.quest.CeremonialCandle;
import com.shatteredpixel.bathredpixeldungeon.items.quest.CorpseDust;
import com.shatteredpixel.bathredpixeldungeon.items.quest.Embers;
...
import com.shatteredpixel.bathredpixeldungeon.levels.rooms.quest.MassGraveRoom;
import com.shatteredpixel.bathredpixeldungeon.levels.rooms.quest.RitualSiteRoom;
import com.shatteredpixel.bathredpixeldungeon.levels.rooms.quest.RotGardenRoom;
...
import com.shatteredpixel.bathredpixeldungeon.sprites.WandmakerSprite;
import com.shatteredpixel.bathredpixeldungeon.windows.WndQuest;
import com.shatteredpixel.bathredpixeldungeon.windows.WndWandmaker;
		...
		if (Quest.given) {
			...
			switch(Dungeon.hero.heroClass){
				...
				case DUELIST:
					...
					break;
				case GIUX:
					msg1 += Messages.get(this, "intro_giux");
					break;
			}
